  ...
  function($scope, $stateParams, $location, Authentication, Units ) {
	  ...
	  // Create new Unit
	   ...
	   $scope.findOne = function() {
		   ...
		   // Gathers up a list of evo units of the unit page
		   var evo_list = [];
		   evo_list.push($scope.unit.evo_1);
		   evo_list.push($scope.unit.evo_2);
		   evo_list.push($scope.unit.evo_3);
		   evo_list.push($scope.unit.evo_4);
		   evo_list.push($scope.unit.evo_5);
		   $scope.evo_list = evo_list;
